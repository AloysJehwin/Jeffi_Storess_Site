...
export default function UserMenu() {
  ...
  if (!user) {
    return (
      <Link
        href="/login"
        className="flex items-center gap-2 px-4 py-2 text-gray-700 hover:text-accent-500 transition-colors"
      >
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <svg className={`w-4 h-4 text-gray-600 transition-transform ${isOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
