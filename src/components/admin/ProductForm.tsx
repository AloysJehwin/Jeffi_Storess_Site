        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {product?.sku && (
            <div>
              ...
              <div className="w-full px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-gray-600 font-mono text-sm">
                {product.sku}
              </div>
          ...
          {!hasVariants && (
          <div>
            <label htmlFor="mpn" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Used in Google Shopping feed</p>
          </div>
          )}
          ...
          <div className="md:col-span-2 flex gap-6">
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-accent-500 focus:ring-accent-500 border-gray-300 rounded"
              />
              <label htmlFor="has_variants_toggle" className="ml-2 block text-sm text-gray-900">
          ...
          {hasVariants && (
            <div className="md:col-span-2 border border-blue-200 rounded-lg p-4 bg-blue-50/50">
              <h3 className="text-sm font-semibold text-gray-900 mb-4">Product Variants</h3>

              {/* Variant Type */}
              <div className="mb-4">
                <label htmlFor="variant_type_input" className="block text-sm font-medium text-gray-700 mb-2">
                  Variant Type *
                </label>
                <input
                  type="text"
                  ...
                  className="w-full max-w-xs px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-transparent"
                  placeholder="e.g. Length, Size, Weight"
                  required={hasVariants}
                />
                <p className="text-xs text-gray-500 mt-1">This label is shown to customers (e.g. &quot;Select Length&quot;)</p>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-300">
                      <th className="text-left py-2 px-2 font-medium text-gray-700">{variantType || 'Variant'} Name *</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">Selling Price *</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">MRP</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">Sale Price</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">Wholesale</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">Stock *</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">MPN</th>
                      <th className="text-left py-2 px-2 font-medium text-gray-700">GTIN</th>
                      {product?.sku && <th className="text-left py-2 px-2 font-medium text-gray-700">SKU</th>}
                  ...
                  <tbody>
                    {variants.map((variant, index) => {
                      ...
                      return (
                        <tr key={variant.id || index} className="border-b border-gray-100">
                          <td className="py-2 px-2">
                            <input
                              type="text"
                              value={variant.variant_name}
                              onChange={(e) => updateVariant(index, 'variant_name', e.target.value)}
                              className="w-full px-3 py-1.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-transparent text-sm"
              ...
              <button
                type="button"
                onClick={addVariant}
                className="mt-3 px-4 py-1.5 text-sm font-medium text-accent-600 border border-accent-300 rounded-lg hover:bg-accent-50 transition-colors"
              >
                + Add Variant
              </button>
