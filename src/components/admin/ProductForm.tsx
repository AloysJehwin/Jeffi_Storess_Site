                            ...
                            {groupVariants.map((variant) => {
                              ...
                              return (
                                <tr key={variant.id || index} className="border-b border-border-default">
                                  ...
                                  <td className="py-2 px-2">
                                    <div className="w-20 flex items-center border border-border-secondary rounded bg-surface overflow-hidden">
                                      ...
                                      <span className="flex-1 text-xs text-foreground font-medium text-center truncate">{({'flat_poly_auto':'Auto','flat_poly_s':'Poly S','flat_poly_m':'Poly M','flat_poly_l':'Poly L','flat_poly_xl':'Poly XL','drill_bit_tube':'Drill Tube','drill_bit_set_case':'Drill Set','corrugated_box':'Box','long_tube':'Long Tube'} as Record<string,string>)[variant.package_type || 'flat_poly_auto'] || 'Auto'}</span>
