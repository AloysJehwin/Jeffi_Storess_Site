...
const QC_QUESTIONS = [
  { questions_id: 'q_undamaged',   type: 'multi',   options: ['Yes', 'No'], required: true  },
  { questions_id: 'q_complete',    type: 'multi',   options: ['Yes', 'No'], required: true  },
  { questions_id: 'q_brand_match', type: 'multi',   options: ['Yes', 'No'], required: true  },
  { questions_id: 'q_unused',      type: 'multi',   options: ['Yes', 'No'], required: false },
  { questions_id: 'q_reason',      type: 'varchar', options: [],            required: false },
]
