        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              <span className="inline-block bg-white/20 backdrop-blur-sm text-white text-xs font-bold uppercase tracking-widest px-4 py-2 rounded-full mb-6 border border-white/30">
              ...
              <div className="flex flex-wrap gap-3 mb-12">
                <Link
                  href="/products"
                  className="bg-secondary-500 hover:bg-secondary-600 text-white px-8 py-3.5 rounded-xl font-bold transition-all text-sm shadow-xl shadow-secondary-900/30 hover:scale-[1.02]"
                >
                  Shop Now
                </Link>
                <Link
                  href="/categories"
                  className="bg-white/15 hover:bg-white/25 text-white px-8 py-3.5 rounded-xl font-semibold transition-all text-sm border border-white/40 backdrop-blur-sm hover:scale-[1.02]"
                >
                  Browse Categories
                </Link>
              </div>
              ...
              <div className="flex items-center gap-8 pt-8 border-t border-white/20">
                <div>
                  ...
                  <p className="text-white/60 text-xs mt-0.5 font-medium">Products</p>
                </div>
                <div className="w-px h-10 bg-white/20" />
                <div>
                  <p className="text-3xl font-black text-white">50+</p>
                  <p className="text-white/60 text-xs mt-0.5 font-medium">Brands</p>
                </div>
                <div className="w-px h-10 bg-white/20" />
                <div>
                  <p className="text-3xl font-black text-white">24/7</p>
                  <p className="text-white/60 text-xs mt-0.5 font-medium">Support</p>
                </div>
              </div>
            </div>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 py-4 px-4 sm:px-8">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-xs hidden sm:block">{item.sub}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="py-12 md:py-20 bg-surface">
          <div className="container mx-auto px-4">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/categories" className="text-sm text-accent-500 hover:text-accent-600 font-semibold flex items-center gap-1 shrink-0 mb-1">
                View All
              ...
              {mainCategories.map((category) => (
                ...
                >
                  <div className="flex flex-col items-center text-center gap-3 p-4 rounded-2xl bg-surface-elevated border border-border-default hover:border-primary-400 hover:shadow-lg hover:-translate-y-1 transition-all duration-200">
                    ...
                    <span className="text-xs font-semibold text-foreground group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors leading-tight">
                      {category.name}
                    </span>
                  </div>
                </Link>
        ...
        <section className="py-12 md:py-20 bg-surface-secondary">
          <div className="container mx-auto px-4">
            <div className="flex items-end justify-between mb-8">
              ...
              <Link href="/products" className="text-sm text-accent-500 hover:text-accent-600 font-semibold flex items-center gap-1 shrink-0 mb-1">
                View All
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            <div className="text-center mt-10">
              <Link
                href="/products"
                className="inline-flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-10 py-4 rounded-xl font-bold transition-all shadow-lg shadow-primary-500/30 hover:scale-[1.02] text-sm"
              >
                View All Products
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-surface rounded-2xl border border-border-default p-5">
                  <p className="text-3xl font-black text-primary-600">10+</p>
                  <p className="text-xs text-foreground-secondary mt-1">Years in Business</p>
                </div>
                <div className="bg-surface rounded-2xl border border-border-default p-5">
                  <p className="text-3xl font-black text-primary-600">1000+</p>
                  <p className="text-xs text-foreground-secondary mt-1">Happy Customers</p>
                </div>
              </div>

              <Link
                href="/about"
                className="inline-flex items-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-7 py-3.5 rounded-xl font-bold transition-all text-sm shadow-lg shadow-primary-500/25 hover:scale-[1.02]"
              >
                Learn More About Us
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <section className="relative py-16 md:py-24 overflow-hidden bg-gradient-to-br from-primary-600 to-primary-700">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/products"
              className="bg-secondary-500 hover:bg-secondary-600 text-white px-10 py-4 rounded-xl font-bold transition-all shadow-xl hover:scale-[1.02] text-sm"
            >
              Browse Products
            </Link>
            <Link
              href="/contact"
              className="bg-white/15 hover:bg-white/25 text-white px-10 py-4 rounded-xl font-bold transition-all border border-white/30 backdrop-blur-sm hover:scale-[1.02] text-sm"
            >
              Contact Us
            </Link>
          </div>
