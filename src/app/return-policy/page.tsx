      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold text-green-800">Returns Accepted</h3>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-8 space-y-8">
            {/* Section 1 */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">1. Defective Product Returns</h2>
            ...
            {/* Section 2 */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">2. No Exchange Policy</h2>
            ...
            {/* Section 3 */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">3. How to Request a Return</h2>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Submit Evidence</h4>
                    <p className="text-gray-600 text-sm">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Approval & Pickup</h4>
                    <p className="text-gray-600 text-sm">
            ...
            {/* Section 4 */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">4. Non-Returnable Items</h2>
              <p className="text-gray-600 mb-4 leading-relaxed">
            ...
            {/* Section 5 */}
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-4">5. Refund Details</h2>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-accent-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
        ...
        {/* CTA */}
        <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-lg shadow-sm p-8 text-center text-white mt-8">
