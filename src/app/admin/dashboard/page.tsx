      ...
      <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-surface-elevated rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-bold text-foreground mt-2">{stats.totalProducts}</p>
              {stats.lowStockProducts > 0 && (
                <p className="text-xs text-red-600 dark:text-red-400 mt-1">{stats.lowStockProducts} low stock</p>
              )}
            </div>
            <div className="hidden sm:block bg-blue-100 dark:bg-blue-900/30 p-3 rounded-full">
        ...
        <div className="bg-surface-elevated rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden sm:block bg-green-100 dark:bg-green-900/30 p-3 rounded-full">
        ...
        <div className="bg-surface-elevated rounded-lg shadow p-4 sm:p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl sm:text-3xl font-bold text-foreground mt-2">{stats.totalCustomers}</p>
            </div>
            <div className="hidden sm:block bg-purple-100 dark:bg-purple-900/30 p-3 rounded-full">
            ...
            <div className="md:hidden space-y-3">
              {recentOrders.map((order) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-foreground-muted">{order.customer_name}</span>
                    <span className="text-sm font-semibold text-foreground">Rs {Number(order.total_amount).toLocaleString('en-IN')}</span>
                  </div>
                </a>
              ))}
            </div>
