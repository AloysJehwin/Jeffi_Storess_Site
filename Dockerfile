...
ARG NEXT_PUBLIC_ENABLE_RAZORPAY
ARG NEXT_PUBLIC_ENABLE_GST
...
ENV NEXT_PUBLIC_ENABLE_RAZORPAY=$NEXT_PUBLIC_ENABLE_RAZORPAY
ENV NEXT_PUBLIC_ENABLE_GST=$NEXT_PUBLIC_ENABLE_GST
